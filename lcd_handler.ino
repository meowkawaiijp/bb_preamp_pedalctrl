...
// Display characters for each menu
void UpdateEntireLcdDisplay(void){
    ...
    if(appVars.mode==MODE_PLAY){
        ...
        lcd.noBlink();
        lcd.setCursor(0, 0);
        lcd.print("VOL GIN  TRE BAS");
        // params
        PrintInt2Digit(appParam.volume, 1,1);
        PrintInt2Digit(appParam.gain, 5,1);
        PrintInt3Digit(appParam.treble, 9,1);
        PrintInt3Digit(appParam.bass, 13,1);
